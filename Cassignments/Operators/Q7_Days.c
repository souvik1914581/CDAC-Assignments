/*7. Write a program to find out difference in days between any two dates. It must work regardless
of the year, month and day. Consider Leap years while calculating the difference.*/
#include<stdio.h>
int isleapyear(int);
...
int main()
{
	...
	printf("Number of days between the two dates is %d\n",diff);
	return 0;
